...
export const Footer = () => {
    return (
        <footer className={styles.container}>
            ...
            <div className={styles.col}>
                <div className={styles.title}>Data Accuracy</div>
                <div className={styles.desc}>
                    Despite efforts to ensure accuracy, this resource may contain errors or inaccuracies and should not be the sole basis for critical decisions, especially those related to health.
                </div>
            </div>
            <div className={styles.col_social}>
                <div className={styles.title}>Подпишись</div>
                <ul className={styles.socials}>
                    <li>
                        <a href="https://github.com/Object-ions/Jelly-Belly-Wiki">
                    ...
                    <li>
                        <a href="https://discord.com/users/1063873143053238414">
